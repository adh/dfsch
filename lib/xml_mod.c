...
void dfsch_module_xml_register(dfsch_object_t* env){
  ...
  dfsch_defcanon_pkgcstr(env, xml_pkg, "make-parser", 
                       DFSCH_PRIMITIVE_REF(make_parser));
  dfsch_defcanon_pkgcstr(env, xml_pkg, "destroy-parser!", 
                       DFSCH_PRIMITIVE_REF(destroy_parser));
  
  dfsch_defcanon_pkgcstr(env, xml_pkg, "set-start-element-proc!", 
                       DFSCH_PRIMITIVE_REF(set_start_element_proc));
  dfsch_defcanon_pkgcstr(env, xml_pkg, "set-end-element-proc!", 
                       DFSCH_PRIMITIVE_REF(set_end_element_proc));
  dfsch_defcanon_pkgcstr(env, xml_pkg, "set-character-data-proc!", 
                       DFSCH_PRIMITIVE_REF(set_character_data_proc));

  dfsch_defcanon_pkgcstr(env, xml_pkg, "parse-eof!", 
                       DFSCH_PRIMITIVE_REF(parse_eof));
  dfsch_defcanon_pkgcstr(env, xml_pkg, "parse-buffer!", 
                       DFSCH_PRIMITIVE_REF(parse_buffer));
  dfsch_defcanon_pkgcstr(env, xml_pkg, "parse-file!", 
                       DFSCH_PRIMITIVE_REF(parse_file));
  dfsch_defcanon_pkgcstr(env, xml_pkg, "parse-port!", 
